    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          ...
          <DialogDescription>Remplissez les informations de l'enseignement</DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-6 py-4 pr-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      placeholder="Ex: Dieu nous aime"
                      required
                    />
                  </div>
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="textesBibliques">Textes bibliques *</Label>
                  <Textarea
                    id="textesBibliques"
                    value={formData.textesBibliques}
                    onChange={(e) => setFormData({ ...formData, textesBibliques: e.target.value })}
                    placeholder="Ex: Jean 3:16, 1 Jean 4:8-10"
                    rows={2}
                    required
                  />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="butPedagogique">But pédagogique *</Label>
                  <Textarea
                    id="butPedagogique"
                ...
                <div className="grid gap-2">
                  <Label htmlFor="versetRetenir">Verset à retenir (V.A.R) *</Label>
                  <Input
                    id="versetRetenir"
              ...
              <div className="space-y-4 border-t pt-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="grid gap-2">
                    <Label htmlFor="materielDidactique">Matériel didactique (M/D)</Label>
                    <Textarea
                      id="materielDidactique"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="sujetRevision">Sujet de révision (S/R)</Label>
                    <Textarea
                      id="sujetRevision"
                      value={formData.sujetRevision}
                      onChange={(e) => setFormData({ ...formData, sujetRevision: e.target.value })}
                      placeholder="Rappel de la leçon précédente..."
                      rows={2}
                    />
                  </div>
                </div>
              ...
              <div className="space-y-4 border-t pt-4">
                ...
                <div className="grid gap-4">
                  <div className="grid gap-2">
                    <Label htmlFor="sensibilisation">Sensibilisation (chants)</Label>
                    <Textarea
                      id="sensibilisation"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="questionsReponses">Questions/Réponses (Q.R)</Label>
                    <Textarea
                      id="questionsReponses"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="questionDecouverte">Question de découverte (Q.D)</Label>
                    <Textarea
                      id="questionDecouverte"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="reponseDecouverte">Réponse de découverte (R)</Label>
                    <Textarea
                      id="reponseDecouverte"
              ...
              <div className="space-y-4 border-t pt-4">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="points_developper" id="points" />
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="developpement" className="font-normal cursor-pointer">
                      Développement
                    </Label>
                  </div>
                </RadioGroup>
              ...
              {formData.typeContenu === "developpement" && (
                <div className="space-y-4 border-t pt-4">
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="developpement">Contenu du développement</Label>
                    <Textarea
                      id="developpement"
                      value={formData.developpement}
                      onChange={(e) => setFormData({ ...formData, developpement: e.target.value })}
                      rows={5}
                      placeholder="Développez le contenu de la leçon..."
                    />
                  </div>
              ...
              <div className="space-y-4 border-t pt-4">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="conclusion">Conclusion de la leçon</Label>
                  <Textarea
                    id="conclusion"
                    value={formData.conclusion}
                    onChange={(e) => setFormData({ ...formData, conclusion: e.target.value })}
                    rows={4}
                    placeholder="Résumé et application pratique..."
                  />
                </div>
              </div>
            </div>
