    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatsCard
          ...
          color="green"
        />
        <StatsCard title="Cultes ce Mois" value="8" description="2 à venir" icon={Church} trend="neutral" color="red" />
      </div>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="dashboard-card col-span-4 border border-gray-200">
          <CardHeader>
            <CardTitle className="text-gray-900">Présence aux Cultes</CardTitle>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="dashboard-card border border-gray-200">
          <CardHeader>
            <CardTitle className="text-gray-900">Statistiques Rapides</CardTitle>
